...
class Gym_Member():
    def __init__(self):
        ...
        '''
        self.details = {'100':{'Membership ID': '100', 'Name': 'Mrunal Shahare', 'Age': '22' , 'Gender': 'Male', 'Mobile Number': '8668362158', 'Email': 'ShahareMrunal@gmail.com', 'BMI': '19', 'Membership Duration(Months)': '12', 'Status': 'Active'},'101':{'Membership ID': '101', 'Name': 'Aditya Shahare', 'Age': '26' , 'Gender': 'Male', 'Mobile Number': '8421547889', 'Email': 'shubham@gmail.com', 'BMI': '23', 'Membership Duration(Months)': '9', 'Status': 'Active'}}
        self.admin = {'admin123':'123admin'}
        self.user = {'100':'1234','101':'4321'}
        self.count = '102'
        self.regimen = {'100':{'Mon': 'Chest', 'Tue': 'Biceps', 'Wed': 'Cardio/Abs', 'Thu': 'Back', 'Fri': 'Triceps', 'Sat': 'legs', 'Sun': 'Rest'},'1000001':{'Mon': 'Chest', 'Tue': 'Biceps', 'Wed': 'Cardio/Abs', 'Thu': 'Back', 'Fri': 'Triceps', 'Sat': 'legs', 'Sun': 'Rest'}}
